...
export default function DateGranularityFilter({
  ...
  const isAllTime = granularity === 'all' || !granularity
  ...
  return (
    <div className="flex flex-wrap gap-3 items-end">
      ...
      <div>
        ...
        <select
          value={granularity === 'month' ? periodValue : defaultMonth}
          onChange={(e) => e.target.value && navigate('month', e.target.value)}
          className={selectClass(granularity === 'month')}
        >
      ...
      <div>
        ...
        <select
          value={granularity === 'week' ? periodValue : defaultWeek}
          onChange={(e) => e.target.value && navigate('week', e.target.value)}
          className={selectClass(granularity === 'week')}
        >
          <option value="" disabled>
            Select week...
          </option>
      ...
      <div>
        ...
        <select
          value={granularity === 'year' ? periodValue : defaultYear}
          onChange={(e) => e.target.value && navigate('year', e.target.value)}
          className={selectClass(granularity === 'year')}
        >
          <option value="" disabled>
            Select year...
          </option>
