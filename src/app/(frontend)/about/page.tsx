  ...
  return (
    <section className="py-16 md:py-28 px-6 lg:px-8 max-w-[1200px] mx-auto bg-white min-h-screen">
      ...
      <div className="grid gap-6 md:gap-8 lg:grid-cols-[380px_1fr]">
        ...
        <div className="bg-[#f5f5f7] rounded-[24px] p-8 md:p-10 flex flex-col justify-center">
        ...
        {/* Map Card */}
        <div className="bg-[#f5f5f7] rounded-[24px] overflow-hidden min-h-[400px] lg:min-h-[500px] flex items-center justify-center relative shadow-[inset_0_0_0_1px_rgba(0,0,0,0.02)]">
          {mapEmbedUrl ? (
            <iframe 
              src={mapEmbedUrl} 
