...
export default async function CalculatorPage() {
  ...
  return (
    <div className="container" style={{ padding: '56px 24px 88px' }}>
      <p className="eyebrow" style={{ marginBottom: 8 }}>Tools</p>
      <h1 style={{ marginBottom: 10 }}>Weight Calculator</h1>
      <p style={{ marginBottom: 32, maxWidth: 560 }}>
        Estimate the weight of steel products by shape and dimension -- useful for planning
        orders and checking delivery loads before you request a quote.
      </p>
