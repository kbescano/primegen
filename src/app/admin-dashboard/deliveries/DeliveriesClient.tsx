...
export default function DeliveriesClient({
  ...
  return (
    <>
      {/* Everything on this page EXCEPT the modal is hidden when printing --
          the list, filters, and header have no business appearing on a
          printed waybill. Only the modal (rendered as a sibling below,
          outside this wrapper) is allowed to print. */}
      <div className="max-w-[1200px] mx-auto py-6 print:hidden">
        <div className="mb-8">
      ...
      {/* The Instant Modal overlay -- rendered as a SIBLING of the list page
          above (not nested inside it), so print:hidden on the list wrapper
          has no effect on the modal, and only the modal's own print rules
          (already print:static / print:block) control what actually prints. */}
      {trackOrderId && (
